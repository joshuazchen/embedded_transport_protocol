/* ==========================================================================
 * package.h: Embedded Transport Protocol (Single master with Single Salve)
 *
...
#define CHECKSUM_HEAD_LEN 4

// Package header
struct pack_header {
	U8 premble[3]; // Premble
	U8 start;      // Start code
	U16 chksum;    // Checksum that computed from 'seqno' to the tail of 'data'
